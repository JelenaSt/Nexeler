...
<div class="page-body container" style="padding:5px; margin:auto;">
    ...
    <div style="width:100%; height:80px;">
        ...
        <p>
             ...
             "Rezerviši" koja se nalazi pored prikaza svake od predstava na repertoaru.
             Nakon što Vam se prikaze dialog, izaberite broj karata koji želite da rezervišite i potvrdite Vaš izbor
            pritiskom na dugme "Potvrdi". Ukoliko imate poteškoća sa rezervacijom, možete nas kontaktirati putem emaila
            ili kontak telefona.
   	   </p>
         <?php else:?>
       <p> Dobrodošli na repertoar Nexeler WebPozorišta. Da biste bili u mogućnosti da iskoristite
        naš online servis za rezervaciju karata molimo Vas da se registrujete. 
           </p>
        <?php endif; ?>
        </div>
